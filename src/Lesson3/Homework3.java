...
public class Homework3 {
    ...
    public static void main(String[] args) {
         ...
         */
        printArray1("5. Find min & max in array\t", array3);
        System.out.println("5. Minimum: " + findMin(array3));
        System.out.println("5. Maximum: " + findMax(array3));
        ...
        /*
         * 8. Написать метод, которому на вход подаётся одномерный
